...
## ⚠️ Important: Hourly Consumption Sensor Fix Available

**Status:** 🔴 Hourly/daily consumption sensors currently broken  
**Impact:** Dashboard charts showing "0" for hourly and daily consumption

### Quick Fix Available
The source sensor `sensor.sahkon_kokonaisenergia` is not loaded in your Home Assistant configuration.

**📖 Fix Guides:**
- **Quick Summary:** [HOURLY_SENSOR_FIX_SUMMARY.md](HOURLY_SENSOR_FIX_SUMMARY.md) (2 min read)
- **Full Guide:** [FIX_HOURLY_CONSUMPTION_SENSOR.md](FIX_HOURLY_CONSUMPTION_SENSOR.md)
- **Automated Script:** `deploy_hourly_sensor_fix.sh` (one command)
- **Checklist:** [HOURLY_SENSOR_DEPLOYMENT_CHECKLIST.md](HOURLY_SENSOR_DEPLOYMENT_CHECKLIST.md)
